...
- Corrección de Auto-Cierre en Modales: Se solucionó el problema por el cual el diálogo de configuración se cerraba automáticamente al cambiar de pestaña debido a una falsa detección de clic fuera del modal cuando éste encogía su altura. Ahora se verifica que el destino del evento de clic sea el propio elemento de diálogo antes de evaluar las coordenadas de clic.
